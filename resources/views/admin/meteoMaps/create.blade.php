...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.meteoMap.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.meteo-maps.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="batch_version">{{ trans('cruds.meteoMap.fields.batch_version') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pressure') ? 'is-invalid' : '' }}" type="text" name="pressure" id="pressure" value="{{ old('pressure', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marker') ? 'is-invalid' : '' }}" type="text" name="marker" id="marker" value="{{ old('marker', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rainfall') ? 'is-invalid' : '' }}" type="text" name="rainfall" id="rainfall" value="{{ old('rainfall', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('snow') ? 'is-invalid' : '' }}" type="text" name="snow" id="snow" value="{{ old('snow', '') }}">
                @if($errors->has('snow'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_temp') ? 'is-invalid' : '' }}" type="text" name="min_temp" id="min_temp" value="{{ old('min_temp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_temp') ? 'is-invalid' : '' }}" type="text" name="max_temp" id="max_temp" value="{{ old('max_temp', '') }}">
