...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.hydroInformation.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.hydro-informations.update", [$hydroInformation->id]) }}"
                  enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required"
                           for="batch_version">{{ trans('cruds.hydroInformation.fields.batch_version') }}</label>
                    <input class="form-control {{ $errors->has('batch_version') ? 'is-invalid' : '' }}" type="text"
                           name="batch_version" id="batch_version"
                           value="{{ old('batch_version', $hydroInformation->batch_version) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('station_id') ? 'is-invalid' : '' }}" type="text"
                           name="station_id" id="station_id" value="{{ old('station_id', $hydroInformation->station_id) }}"
                           required>
                ...
                <div class="form-group">
                    <label class="required"
                           for="station_name">{{ trans('cruds.hydroInformation.fields.station_name') }}</label>
                    <input class="form-control {{ $errors->has('station_name') ? 'is-invalid' : '' }}" type="text"
                           name="station_name" id="station_name"
                           value="{{ old('station_name', $hydroInformation->station_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('alt') ? 'is-invalid' : '' }}" type="text" name="alt"
                           id="alt" value="{{ old('alt', $hydroInformation->alt) }}" required>
                    @if($errors->has('alt'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lng') ? 'is-invalid' : '' }}" type="text" name="lng"
                           id="lng" value="{{ old('lng', $hydroInformation->lng) }}" required>
                    @if($errors->has('lng'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat"
                           id="lat" value="{{ old('lat', $hydroInformation->lat) }}" required>
                    @if($errors->has('lat'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('absolute_min') ? 'is-invalid' : '' }}" type="text"
                           name="absolute_min" id="absolute_min"
                           value="{{ old('absolute_min', $hydroInformation->absolute_min) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('absolute_min_date') ? 'is-invalid' : '' }}" type="text"
                           name="absolute_min_date" id="absolute_min_date"
                           value="{{ old('absolute_min_date', $hydroInformation->absolute_min_date) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('absolute_max') ? 'is-invalid' : '' }}" type="text"
                           name="absolute_max" id="absolute_max"
                           value="{{ old('absolute_max', $hydroInformation->absolute_max) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('absolute_max_date') ? 'is-invalid' : '' }}" type="text"
                           name="absolute_max_date" id="absolute_max_date"
                           value="{{ old('absolute_max_date', $hydroInformation->absolute_max_date) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('regular_elevation') ? 'is-invalid' : '' }}" type="text"
                           name="regular_elevation" id="regular_elevation"
                           value="{{ old('regular_elevation', $hydroInformation->regular_elevation) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('irregular_elevation') ? 'is-invalid' : '' }}"
                           type="text" name="irregular_elevation" id="irregular_elevation"
                           value="{{ old('irregular_elevation', $hydroInformation->irregular_elevation) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('about') ? 'is-invalid' : '' }}" type="text" name="about"
                           id="about" value="{{ old('about', $hydroInformation->about) }}">
                    @if($errors->has('about'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}" type="text"
                           name="period" id="period" value="{{ old('period', $hydroInformation->period) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('water_level') ? 'is-invalid' : '' }}" type="text"
                           name="water_level" id="water_level"
                           value="{{ old('water_level', $hydroInformation->water_level) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('temperature') ? 'is-invalid' : '' }}" type="text"
                           ...
                           value="{{ old('temperature', $hydroInformation->temperature) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                              name="description"
                              id="description">{!! old('description', $hydroInformation->description) !!}</textarea>
