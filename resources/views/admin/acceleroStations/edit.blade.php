...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.acceleroStation.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.accelero-stations.update", [$acceleroStation->id]) }}"
                  enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required"
                           for="batch_version">{{ trans('cruds.acceleroStation.fields.batch_version') }}</label>
                    <input class="form-control {{ $errors->has('batch_version') ? 'is-invalid' : '' }}" type="text"
                           name="batch_version" id="batch_version"
                           value="{{ old('batch_version', $acceleroStation->batch_version) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('serial_number') ? 'is-invalid' : '' }}" type="text"
                           ...
                           value="{{ old('serial_number', $acceleroStation->serial_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('station_id') ? 'is-invalid' : '' }}" type="text"
                           name="station_id" id="station_id" value="{{ old('station_id', $acceleroStation->station_id) }}" required>
                ...
                <div class="form-group">
                    <label class="required"
                           for="station_name">{{ trans('cruds.acceleroStation.fields.station_name') }}</label>
                    <input class="form-control {{ $errors->has('station_name') ? 'is-invalid' : '' }}" type="text"
                           name="station_name" id="station_name"
                           value="{{ old('station_name', $acceleroStation->station_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('network_code') ? 'is-invalid' : '' }}" type="text"
                           name="network_code" id="network_code"
                           value="{{ old('network_code', $acceleroStation->network_code) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('alt') ? 'is-invalid' : '' }}" type="text" name="alt"
                           id="alt" value="{{ old('alt', $acceleroStation->alt) }}" required>
                    @if($errors->has('alt'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lng') ? 'is-invalid' : '' }}" type="text" name="lng"
                           id="lng" value="{{ old('lng', $acceleroStation->lng) }}" required>
                    @if($errors->has('lng'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat"
                           id="lat" value="{{ old('lat', $acceleroStation->lat) }}" required>
                    @if($errors->has('lat'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('digitizer') ? 'is-invalid' : '' }}" type="text"
                           name="digitizer" id="digitizer" value="{{ old('digitizer', $acceleroStation->digitizer) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sensor') ? 'is-invalid' : '' }}" type="text"
                           name="sensor" id="sensor" value="{{ old('sensor', $acceleroStation->sensor) }}">
