    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-pageProjects">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.project.fields.cover_photo') }}
                            </th>
                            <th>
                            ...
                            <tr data-entry-id="{{ $project->id }}">
                                ...
                                <td>
                                    @if($project->cover_photo)
                                        <a href="{{ $project->cover_photo->getUrl() }}" target="_blank" style="display: inline-block">
                                            <img src="{{ $project->cover_photo->getUrl('thumb') }}">
                                        </a>
                                    @endif
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-pageProjects:not(.ajaxTable)').DataTable({ buttons: dtButtons })
