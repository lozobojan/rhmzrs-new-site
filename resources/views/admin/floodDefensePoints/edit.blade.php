...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.floodDefensePoint.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.flood-defense-points.update", [$floodDefensePoint->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="ordinal_number">{{ trans('cruds.floodDefensePoint.fields.ordinal_number') }}</label>
                <input class="form-control {{ $errors->has('ordinal_number') ? 'is-invalid' : '' }}" type="number" name="ordinal_number" id="ordinal_number" value="{{ old('ordinal_number', $floodDefensePoint->ordinal_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place') ? 'is-invalid' : '' }}" type="text" name="place" id="place" value="{{ old('place', $floodDefensePoint->place) }}" required>
                @if($errors->has('place'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('river_basin') ? 'is-invalid' : '' }}" name="river_basin_id" id="river_basin_id" required>
                    @foreach($river_basins as $id => $entry)
                        <option value="{{ $id }}" {{ (old('river_basin_id') ? old('river_basin_id') : $floodDefensePoint->river_basin->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ordinary_value') ? 'is-invalid' : '' }}" type="number" name="ordinary_value" id="ordinary_value" value="{{ old('ordinary_value', $floodDefensePoint->ordinary_value) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extraordinary_value') ? 'is-invalid' : '' }}" type="number" name="extraordinary_value" id="extraordinary_value" value="{{ old('extraordinary_value', $floodDefensePoint->extraordinary_value) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nnv') ? 'is-invalid' : '' }}" type="text" name="nnv" id="nnv" value="{{ old('nnv', $floodDefensePoint->nnv) }}">
                @if($errors->has('nnv'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vvv') ? 'is-invalid' : '' }}" type="text" name="vvv" id="vvv" value="{{ old('vvv', $floodDefensePoint->vvv) }}">
                @if($errors->has('vvv'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kote0') ? 'is-invalid' : '' }}" type="text" name="kote0" id="kote0" value="{{ old('kote0', $floodDefensePoint->kote0) }}">
                @if($errors->has('kote0'))
