...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.ecoInformation.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.eco-information.update", [$ecoInformation->id]) }}"
                  enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required"
                           for="batch_version">{{ trans('cruds.ecoInformation.fields.batch_version') }}</label>
                    <input class="form-control {{ $errors->has('batch_version') ? 'is-invalid' : '' }}" type="text"
                           name="batch_version" id="batch_version"
                           value="{{ old('batch_version', $ecoInformation->batch_version) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('station_id') ? 'is-invalid' : '' }}" type="text"
                           name="station_id" id="station_id" value="{{ old('station_id', $ecoInformation->station_id) }}">
                ...
                <div class="form-group">
                    <label class="required"
                           for="station_name">{{ trans('cruds.ecoInformation.fields.station_name') }}</label>
                    <input class="form-control {{ $errors->has('station_name') ? 'is-invalid' : '' }}" type="text"
                           name="station_name" id="station_name"
                           value="{{ old('station_name', $ecoInformation->station_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('alt') ? 'is-invalid' : '' }}" type="text" name="alt"
                           id="alt" value="{{ old('alt', $ecoInformation->alt) }}" required>
                    @if($errors->has('alt'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lng') ? 'is-invalid' : '' }}" type="text" name="lng"
                           id="lng" value="{{ old('lng', $ecoInformation->lng) }}" required>
                    @if($errors->has('lng'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat"
                           id="lat" value="{{ old('lat', $ecoInformation->lat) }}" required>
                    @if($errors->has('lat'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}" type="text" name="period"
                           id="period" value="{{ old('period', $ecoInformation->period) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('temperature') ? 'is-invalid' : '' }}" type="text" name="temperature"
                           id="temperature" value="{{ old('temperature', $ecoInformation->temperature) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('humidity') ? 'is-invalid' : '' }}" type="text" name="humidity"
                           id="humidity" value="{{ old('humidity', $ecoInformation->humidity) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pressure') ? 'is-invalid' : '' }}" type="text" name="pressure"
                           id="pressure" value="{{ old('pressure', $ecoInformation->pressure) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('solar_radiation') ? 'is-invalid' : '' }}" type="text" name="solar_radiation"
                           id="solar_radiation" value="{{ old('solar_radiation', $ecoInformation->solar_radiation) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('rainfall') ? 'is-invalid' : '' }}" type="text" name="rainfall"
                           id="rainfall" value="{{ old('rainfall', $ecoInformation->rainfall) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wind_speed') ? 'is-invalid' : '' }}" type="text" name="wind_speed"
                           id="wind_speed" value="{{ old('wind_speed', $ecoInformation->wind_speed) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wind_direction') ? 'is-invalid' : '' }}" type="text" name="wind_direction"
                           id="wind_direction" value="{{ old('wind_direction', $ecoInformation->wind_direction) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('o3') ? 'is-invalid' : '' }}" type="text" name="o3"
                           id="o3" value="{{ old('o3', $ecoInformation->o3) }}" required>
                    @if($errors->has('o3'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('co') ? 'is-invalid' : '' }}" type="text" name="co"
                           id="co" value="{{ old('co', $ecoInformation->co) }}" required>
                    @if($errors->has('co'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('no2') ? 'is-invalid' : '' }}" type="text" name="no2"
                           id="no2" value="{{ old('no2', $ecoInformation->no2) }}" required>
                    @if($errors->has('no2'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('so2') ? 'is-invalid' : '' }}" type="text" name="so2"
                           id="so2" value="{{ old('so2', $ecoInformation->so2) }}" required>
                    @if($errors->has('so2'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nox') ? 'is-invalid' : '' }}" type="text" name="nox"
                           id="nox" value="{{ old('nox', $ecoInformation->nox) }}" required>
                    @if($errors->has('nox'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pm10') ? 'is-invalid' : '' }}" type="text" name="pm10"
                           id="pm10" value="{{ old('pm10', $ecoInformation->pm10) }}" required>
                    @if($errors->has('pm10'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ik') ? 'is-invalid' : '' }}" type="text" name="ik"
                           id="ik" value="{{ old('ik', $ecoInformation->ik) }}" required>
                    @if($errors->has('ik'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pm25') ? 'is-invalid' : '' }}" type="text" name="pm25"
                           id="pm25" value="{{ old('pm25', $ecoInformation->pm25) }}" required>
                    @if($errors->has('pm25'))
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                              name="description"
                              id="description">{!! old('description', $ecoInformation->description) !!}</textarea>
