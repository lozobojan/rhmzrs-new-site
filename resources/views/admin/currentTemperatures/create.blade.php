...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.currentTemperature.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.current-temperatures.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="batch_version">{{ trans('cruds.currentTemperature.fields.batch_version') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="station_name">{{ trans('cruds.currentTemperature.fields.station_name') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="current_temperature">{{ trans('cruds.currentTemperature.fields.current_temperature') }}</label>
                <input class="form-control {{ $errors->has('current_temperature') ? 'is-invalid' : '' }}" type="text" name="current_temperature" id="current_temperature" value="{{ old('current_temperature', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', '1215.png') }}">
