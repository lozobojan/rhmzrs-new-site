<div>
    ...
    <script src="{{asset('js/current-temperatures-leaflet.js')}}"></script>
    ...
    <table id="example" class="table table-bordered table-striped" style="width:100%">
        ...
        <tr role="row">
            ...
            <th class="sorting_asc" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1"
                aria-label="Опис: activate to sort column descending" style="width: 319px;" aria-sort="ascending">Трен. Темп. °C
            </th>
            <th class="sorting_asc" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1"
