<div>
    ...
    <script src="{{asset('js/wind-leaflet.js')}}"></script>
    ...
    <table id="example" class="table table-bordered table-striped" style="width:100%">
        ...
        <tr role="row">
            <th class="sorting" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1"
                aria-label="Станица: activate to sort column ascending" style="width: 140px;">Град
            </th>
            ...
            <th class="sorting_asc" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1"
                aria-label="Опис: activate to sort column descending" style="width: 319px;" aria-sort="ascending">Смијер
            </th>
{{--            <th class="sorting_asc" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1"--}}
