...
class QuestionnaireController extends Controller
{
    ...
    public function store(StoreQuestionnaireRequest $request)
    {
        ...
        if ($media = $request->input('ck-media', false)) {
            Media::whereIn('id', $media)->update(['model_id' => $questionnaire->id]);
        }
    ...
    public function show(Questionnaire $questionnaire)
    {
        ...
        $questionnaire->load('questionnaireQuestions');
    ...
    {
        abort_if(Gate::denies('questionnaire_create') && Gate::denies('questionnaire_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
